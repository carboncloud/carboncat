...
import { NumberInput, SettingsCheckbox, SettingsNumberInput } from './Components';
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-2 px-4 pt-4">
            <NumberInput
              ...
              hidden={false}
              onChange={(v) => {
                settingsDispatch({ type: 'SET_TABLE_LINE_HEIGHT', payload: v });
              }}
            />
            <SettingsNumberInput
              label="Query Limit"
              value={settingsState.maxNumberOfLines}
              onChange={(v) => {
                settingsDispatch({ type: 'SET_MAX_NUMBER_OF_LINES', payload: v });
              }}
            />
            <SettingsCheckbox
              key="state"
              ...
              onChange={() => {
                settingsDispatch({ type: 'TOGGLE_SAVE_STATE' });
              }}
            />
          </div>
        </div>
